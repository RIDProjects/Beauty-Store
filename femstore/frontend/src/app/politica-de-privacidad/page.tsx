      ...
      <main className="min-h-screen bg-transparent py-12">
        <div className="page-container max-w-3xl">
          ...
          <div className="card p-8 space-y-6 text-[var(--color-text)] text-sm leading-relaxed">
            <section>
              <h2 className="text-lg font-semibold text-[var(--color-text)] mb-2">1. Información que recopilamos</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[var(--color-text)] mb-2">2. Uso de la información</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[var(--color-text)] mb-2">3. Protección de datos</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[var(--color-text)] mb-2">4. Cookies</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[var(--color-text)] mb-2">5. Contacto</h2>
