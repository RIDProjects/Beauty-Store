      ...
      <>
        ...
        <main className="min-h-screen bg-transparent py-8">
          <div className="page-container max-w-5xl">
            <div className="animate-pulse mb-6 h-4 bg-gray-200 dark:bg-[#243526] rounded w-32" />
            <div className="grid md:grid-cols-2 gap-10">
              <div className="space-y-3">
                <div className="aspect-square bg-gray-200 dark:bg-[#243526] rounded-2xl" />
                <div className="flex gap-2">
                  {[...Array(3)].map((_, i) => (
                    <div key={i} className="w-16 h-16 bg-gray-200 dark:bg-[#243526] rounded-xl" />
                  ))}
                </div>
              </div>
              <div className="space-y-4 animate-pulse">
                <div className="h-3 bg-gray-200 dark:bg-[#243526] rounded w-1/4" />
                <div className="h-8 bg-gray-200 dark:bg-[#243526] rounded w-3/4" />
                <div className="h-7 bg-gray-200 dark:bg-[#243526] rounded w-1/3" />
                <div className="space-y-2 pt-2">
                  <div className="h-3 bg-gray-200 dark:bg-[#243526] rounded" />
                  <div className="h-3 bg-gray-200 dark:bg-[#243526] rounded w-5/6" />
                  <div className="h-3 bg-gray-200 dark:bg-[#243526] rounded w-4/6" />
                </div>
                <div className="h-12 bg-gray-200 dark:bg-[#243526] rounded-xl mt-4" />
              </div>
            </div>
          </div>
        </main>
